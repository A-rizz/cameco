...
/**
 * FebruaryFirstHalfPayrollSeeder
 *
 * Seeds payroll period and finalized attendance data for February 1st Half (Feb 2–13).
 *
 ...
 *
 * **Workflow:**
 * 1. Reset any existing period with `period_number = '2026-02-1H'` (safe to re-run)
 ...
 * - Start: Feb 2, 2026 (first workday; Feb 1 is Sunday)
 * - End:   Feb 13, 2026 (last workday before Feb 16)
 * - Working Days: 10 (Mon–Fri of weeks: Feb 2-6, Feb 9-13)
 * - Payment Date: Feb 20, 2026
 * - Cutoff Date: Feb 13, 2026
 *
 * **Usage:**
 * ```bash
 ...
 */
class FebruaryFirstHalfPayrollSeeder extends Seeder
{
    private const PERIOD_NUMBER   = '2026-02-1H';
    private const PERIOD_NAME     = 'February 2026 - 1st Half';
    private const PERIOD_START    = '2026-02-02';  // Feb 1 is Sunday → first workday is Feb 2
    private const PERIOD_END      = '2026-02-13';  // Last workday before Feb 16
    private const PAYMENT_DATE    = '2026-02-20';
    private const CUTOFF_DATE     = '2026-02-13';

    public function run(): void
    {
        $this->command->info('=== FebruaryFirstHalfPayrollSeeder (1st Half: Feb 2–13) ===');
