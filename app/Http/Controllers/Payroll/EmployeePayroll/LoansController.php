        ...
        try {
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'installments_paid' => $loan->installments_paid,
                    'principal_amount' => (float)$loan->principal_amount,
                    'total_amount' => (float)($loan->principal_amount + ($loan->principal_amount * ($loan->interest_rate / 100))),
                    'monthly_amortization' => (float)$loan->monthly_amortization,
                    'remaining_balance' => max(0, (float)($loan->principal_amount - ($loan->installments_paid * $loan->monthly_amortization))),
                    'payments' => $payments,
                ],
